...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> 總管理員 <b class="caret"></b></a>
            <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li>
                    <a href={{ url('/home') }}><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                </li>
            </ul>
        </li>
    </ul>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                <a href="{{ route('admin.comments.index') }}"><i class="fa fa-fw fa-edit"></i> 留言管理</a>
            </li>
        </ul>
    </div>
    <!-- /.navbar-collapse -->
